	...
	<div class="wrapper">
		...
		<div class="container">
			<ul class="container-1">
				<li>
					<img src="../jsp/images/거울1.PNG" width="350px">
			...
			<li>
				<img src="../jsp/images/거울2.PNG" width="350px">
					<div class="caption-text">
						<h1>금속프레임 전신 거울</h1>
						<p>Every object has a use</p>
					</div>
			...
			<li>
				<img src="../jsp/images/거울3.PNG" width="350px">
					<div class="caption-text">
						<h1>팔각거울</h1>
						<p>Every object has a use</p>
					</div>
			...
			<li>
				<img src="../jsp/images/거울4.PNG" width="350px">
					<div class="caption-text">
						<h1>탁상거울</h1>
						<p>Every object has a use</p>
					</div>
			...
			<li>
				<img src="../jsp/images/거울5.JPG" width="350px">
					<div class="caption-text">
						<h1>원형거울</h1>
						<p>Every object has a use</p>
					</div>
			...
			<li>
				<img src="../jsp/images/거울6.JPG" width="350px">
					<div class="caption-text">
						<h1>팔각거울</h1>
						<p>Every object has a use</p>
					</div>
